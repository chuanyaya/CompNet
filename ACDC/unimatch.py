...
parser.add_argument('--port', default=None, type=int, help='Automatically passed by torchrun')
...
def main():
    ...
    torch.cat((img_u_s1, img_u_s2)), need_fp=True, input_type="strong")
            ...
            loss_complete_dice = criterion_dice(
                pred_complete_s.softmax(dim=1),
