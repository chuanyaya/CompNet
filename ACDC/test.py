...
def Inference():
    ...
    snapshot_path = snapshot_path = f'exp/acdc/{FLAGS.exp}/{FLAGS.model}/{FLAGS.labeled_num}'
    test_save_path = f"exp/acdc/{FLAGS.exp}/{FLAGS.model}/{FLAGS.labeled_num}/{FLAGS.subfolder}/predictions/"
...
if __name__ == '__main__':
    metric = Inference()
    os.environ["CUDA_VISIBLE_DEVICES"] = "2"  # 固定使用第二张显卡
    torch.cuda.set_device(0)  # 因为CUDA_VISIBLE_DEVICES设置后索引会重置
